...
export const FAQS_DATA: FAQ[] = [
  ...
  { id: "4", question: "Are the crypto events real-time?", answer: "The events displayed on the /events page are currently curated mock data for demonstration purposes. The homepage ticker also uses static mock data." },
...
const BITCOIN_MOCK_PRICE_USD = 61500.00;
const ETHEREUM_MOCK_PRICE_USD = 3400.00;
const SOLANA_MOCK_PRICE_USD = 135.00;
const TETHER_MOCK_PRICE_USD = 1.00;
const SHIBA_INU_MOCK_PRICE_USD = 0.000017;
...
export const MOCK_PORTFOLIO_ASSETS_DATA: PortfolioAsset[] = [
  ...
  },
  {
    ...
    symbol: "SOL",
    amount: 50,
    currentPriceUsd: SOLANA_MOCK_PRICE_USD,
    valueUsd: 50 * SOLANA_MOCK_PRICE_USD,
    iconUrl: "https://placehold.co/32x32.png",
  ...
  },
  {
    ...
    symbol: "USDT",
    amount: 5000,
    currentPriceUsd: TETHER_MOCK_PRICE_USD,
    valueUsd: 5000 * TETHER_MOCK_PRICE_USD,
    iconUrl: "https://placehold.co/32x32.png",
  ...
  },
  {
    ...
    currentPriceUsd: SHIBA_INU_MOCK_PRICE_USD,
    valueUsd: 500000000 * SHIBA_INU_MOCK_PRICE_USD,
    iconUrl: "https://placehold.co/32x32.png",
