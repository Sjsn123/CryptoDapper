...
export const FAQS_DATA: FAQ[] = [
  ...
  { id: "4", question: "Are the crypto events real-time?", answer: "The events displayed on the /events page are mock data generated by AI for demonstration purposes, designed to simulate real-time updates. The homepage ticker uses static mock data." },
...
export const MOCK_PORTFOLIO_ASSETS_DATA: PortfolioAsset[] = [
  {
    ...
    symbol: "BTC",
    amount: 0.5,
    currentPriceUsd: 69000, // Updated mock USD price
    valueUsd: 34500,
