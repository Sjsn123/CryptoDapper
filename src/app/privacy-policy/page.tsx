    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none text-muted-foreground prose-headings:text-foreground">
          ...
          <p>Welcome to Digital Dapper! This is a demonstration application, and this Privacy Policy is a placeholder to illustrate how such a page would look.</p>

          <h2>1. Information We Collect (Mock)</h2>
          <p>Since Digital Dapper is a mock application, we do not collect or store real personal information. Any data you enter (e.g., email for mock registration, promo codes) is processed locally in your browser or for demonstration purposes only and is not persisted on a server in a way that identifies you personally.</p>
          ...
          <p>Digital Dapper does not integrate with real third-party services that would collect your personal data. Any mention of third-party services (like OAuth providers) is for simulation purposes only.</p>
          ...
          <h2>6. Your Rights</h2>
          <p>As no real personal data is collected, rights related to data access, correction, or deletion are not applicable in the traditional sense. You can clear your browser&apos;s local storage to remove any mock data stored by Digital Dapper.</p>
